...
import com.vkontakte.miracle.engine.view.fragmentContainer.TabsFragmentContainer.Adapter;
...
@Deprecated
public class MiracleActivityD extends AppCompatActivity {
    ...
    private void iniFragmentController(Bundle savedInstanceState){
        ...
        Adapter adapter =
                new Adapter(getSupportFragmentManager(), fabrics);
        tabsFragmentContainer.setAdapter(adapter);
        adapter.setUpWithNavigationBarView(navigationBarView);
        navigationBarView.setSelectedItemId(R.id.tab_feed);
        tabsFragmentContainer.setOnFragmentChangeListener(this::hideKeyboard);
    }
    ...
    public void addFragment(Fragment fragment){
        Adapter adapter = tabsFragmentContainer.getAdapter();
        if(adapter !=null) {
    ...
    public void onClearSavedInstance(@NonNull Bundle savedInstanceState) {
        ...
        if (key != null) {
            ...
            savedInstanceState.remove("ControllerSavedData");
        }
    }
    ...
    protected void onResume() {
        ...
        if(savedInstanceState!=null&&!savedInstanceState.isEmpty()) {
            onClearSavedInstance(savedInstanceState);
        }
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        if(adapter !=null){
            //Adapter.ControllerSavedState controllerSavedData =
    ...
    //TODO необходимо перенести контроллер пользователя в APP
