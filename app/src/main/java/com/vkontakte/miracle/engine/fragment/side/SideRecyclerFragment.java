...
public abstract class SideRecyclerFragment extends BaseRecyclerFragment implements ISideFragment{
    ...
    public View inflateRootView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_with_recycleview, container, false);
    }
