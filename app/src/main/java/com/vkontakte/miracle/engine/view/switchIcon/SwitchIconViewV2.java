package com.vkontakte.miracle.engine.view.switchIcon;
...
public class SwitchIconViewV2  extends AppCompatImageView {
    ...
    private final int disabledStateBackgroundColor;
    ...
    public SwitchIconViewV2(@NonNull Context context) {
        this(context, null);
    }

    public SwitchIconViewV2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwitchIconViewV2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        setLayerType(LAYER_TYPE_SOFTWARE, null);

        TypedArray array = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.SwitchIconViewV2, 0, 0);

        try {
            iconTintColor = array.getColor(R.styleable.SwitchIconViewV2_si_tint_color, Color.BLACK);
            backgroundTintColor = array.getColor(R.styleable.SwitchIconViewV2_si_background_tint_color, Color.WHITE);
            animationDuration = array.getInteger(R.styleable.SwitchIconViewV2_si_animation_duration, DEFAULT_ANIMATION_DURATION);
            disabledStateAlpha = array.getFloat(R.styleable.SwitchIconViewV2_si_disabled_alpha, DEFAULT_DISABLED_ALPHA);
            disabledStateColor = array.getColor(R.styleable.SwitchIconViewV2_si_disabled_color, iconTintColor);
            disabledStateBackgroundColor = array.getColor(R.styleable.SwitchIconViewV2_si_disabled_background_color, backgroundTintColor);
            enabled = array.getBoolean(R.styleable.SwitchIconViewV2_si_enabled, true);
            noDash = array.getBoolean(R.styleable.SwitchIconViewV2_si_no_dash, false);
        } finally {
            array.recycle();
        }
        ...
        setColorFilter(iconTintColor, PorterDuff.Mode.SRC_IN);
    ...
    private void updateColor(float fraction) {
        if (iconTintColor != disabledStateColor) {
            ...
            final int color2 = (int) colorEvaluator.evaluate(fraction,backgroundTintColor , disabledStateBackgroundColor);
