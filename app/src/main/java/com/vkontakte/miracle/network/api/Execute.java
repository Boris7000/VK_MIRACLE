...
public class Execute {
    ...
    public static Call<JSONObject> getFullGroupNewNew(String group_id, String access_token){
        return execute().getFullGroupNewNew(group_id, 50,1,1,0,0,0,access_token,latest_api_v);
    }
