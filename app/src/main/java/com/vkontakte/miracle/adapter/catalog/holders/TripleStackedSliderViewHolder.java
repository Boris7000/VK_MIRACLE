...
import com.vkontakte.miracle.adapter.catalog.CatalogTripleStackedSliderAdapter;
...
public class TripleStackedSliderViewHolder extends MiracleViewHolder {
    ...
    public TripleStackedSliderViewHolder(@NonNull View itemView, ViewGroup viewGroup) {
        super(itemView);
    ...
    public void bind(ItemDataHolder itemDataHolder) {
        ...
        CatalogTripleStackedSliderAdapter catalogSliderAdapter =
                new CatalogTripleStackedSliderAdapter(catalogBlock);
