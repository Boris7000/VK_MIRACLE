...
public class MutualFriendsAdapter extends MiracleAsyncLoadAdapter {

    private final String ownerId;

    public MutualFriendsAdapter(String ownerId) {
    ...
    public void onLoading() throws Exception {
        ...
        Response<JSONObject> response =
                Friends.getMutual(userItem.getId(), ownerId, userItem.getAccessToken()).execute();
