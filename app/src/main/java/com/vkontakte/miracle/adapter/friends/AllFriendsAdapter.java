...
public class AllFriendsAdapter extends MiracleAsyncLoadAdapter {

    private final String ownerId;

    public AllFriendsAdapter(String ownerId) {
    ...
    public void onLoading() throws Exception {
        ...
        Response<JSONObject> response =
                Friends.get(getStep(), getLoadedCount(), "hints", ownerId, userItem.getAccessToken()).execute();
