...
public class ExtendedAppCompatButton extends AppCompatButton implements ExtendedTextViewIcons{

    private final ExtendedTextHelper textHelper = new ExtendedTextHelper(this);

    public ExtendedAppCompatButton(@NonNull Context context) {
        this(context, null);
    }

    public ExtendedAppCompatButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.materialButtonStyle);
    }

    public ExtendedAppCompatButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
