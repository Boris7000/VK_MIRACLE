...
public class ExtendedAppCompatTextView extends AppCompatTextView implements ExtendedTextViewIcons{

    private final ExtendedTextHelper textHelper = new ExtendedTextHelper(this);

    public ExtendedAppCompatTextView(@NonNull Context context) {
        this(context, null);
    }

    public ExtendedAppCompatTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public ExtendedAppCompatTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
