...
public abstract class BaseListFragment extends ListFragment implements IBaseFragment {
    ...
    private final BaseFragmentController<BaseListFragment> baseController =
            new BaseFragmentController<BaseListFragment>(this){};
    ...
    public View inflateRootView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_with_list_base, container, false);
    }
