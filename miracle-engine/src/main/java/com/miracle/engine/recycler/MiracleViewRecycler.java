...
public class MiracleViewRecycler {
    ...
    static final String LOG_TAG = "MiracleViewRecycler";
    ...
    public RecyclerView.ViewHolder getRecycledView(int viewType) {
        ...
        if (scrapData != null && !scrapData.mScrapHeap.isEmpty()) {
            final ArrayList<RecyclerView.ViewHolder> scrapHeap = scrapData.mScrapHeap;
            if(DEBUG) {
                Log.d(LOG_TAG, "get view of type = " + viewType + ", scrap size = " + (scrapHeap.size()-1));
            }
    ...
    public void putRecycledView(RecyclerView.ViewHolder scrap, int viewType) {
        ...
        scrapHeap.add(scrap);
        if(DEBUG) {
            Log.d(LOG_TAG, "put view of type = " + viewType + ", scrap size = " + scrapHeap.size());
        }
    }
