            ...
            navigationBarView.setOnItemReselectedListener(item -> {
                ...
                if(whoReselectedTab!=null){
                    ...
                    if(whoReselectedFragment!=null){
                        if(whoReselectedFragment instanceof IScrollableFragment) {
                            IScrollableFragment scrollableFragment = (IScrollableFragment) whoReselectedFragment;
                            if (handleNavigationBarAction) {
                                if (scrollableFragment.notTop()) {
        ...
        public void addFragment(Fragment fragment){
            ...
            if(tabHolder!=null){
                if(fragment instanceof IBaseFragment){
                    ((IBaseFragment) fragment).setCanBackClick(tabHolder.getCount()>0);
                }
                Fragment whoNeedHide = tabHolder.getLastFragment();
                tabHolder.addFragment(fragment);
                FragmentTransaction fragmentTransaction = fm.beginTransaction();
